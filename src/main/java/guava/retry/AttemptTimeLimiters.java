...
public class AttemptTimeLimiters {
   ...
   * through the other factory method, {@link #fixedTimeLimit(long, TimeUnit, ExecutorService)}. See
   * the note on {@link SimpleTimeLimiter#SimpleTimeLimiter(ExecutorService)}, which this
  ...
  private static final class FixedAttemptTimeLimit<V> implements AttemptTimeLimiter<V> {
    ...
    private FixedAttemptTimeLimit(@Nonnull TimeLimiter timeLimiter, long duration,
        @Nonnull TimeUnit timeUnit) {
