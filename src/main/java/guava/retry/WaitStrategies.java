...
public final class WaitStrategies {
   ...
   * @param increment            the increment added to the previous sleep time after each failed
   *                             attempt
  ...
  private static final class ExponentialWaitStrategy implements WaitStrategy {
    ...
    public ExponentialWaitStrategy(long multiplier,
      ...
      Preconditions.checkArgument(maximumWait >= 0L, "maximumWait must be >= 0 but is %d",
          maximumWait);
